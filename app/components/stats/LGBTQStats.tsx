...
interface LGBTQStatsProps {
  companyData: CompanyData;
}

export const LGBTQStats = ({ companyData }: LGBTQStatsProps) => {
  return (
    <StatsBox
      title="LGBTQ+ Inclusion"
      footerText="UK employers are not required to report LGBTQ+ representation data"
    >
          ...
          <AccordionItem value="percentageEmployees" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                ...
                {companyData.lgbtqStats?.percentageEmployees ? (
      ...
      <li className="bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-200 dark:border-gray-700">
        <Accordion type="single" collapsible>
          <AccordionItem value="employeeNetwork" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                <span className="text-sm font-medium">Pride Network</span>
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.employeeNetwork
                    ? "Available"
                    : "Not reported"}
                </span>
              </div>
          ...
          <AccordionItem value="pronounPolicy" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                ...
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.pronounPolicy
                    ? "In place"
                    : "Not reported"}
                </span>
              </div>
          ...
          <AccordionItem value="genderNeutralBathrooms" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                ...
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.genderNeutralBathrooms
                    ? "Available"
                    : "Not reported"}
                </span>
              </div>
          ...
          <AccordionItem value="partnerBenefits" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                ...
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.partnerBenefits
                    ? "Equal policy"
                    : "Not reported"}
                </span>
              </div>
            ...
            <AccordionContent>
              <p className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 p-3 rounded-lg">
                ...
                including health insurance, leave policies, and other company
                benefits.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="transitionSupport" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                <span className="text-sm font-medium">Transition Support</span>
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.transitionSupport
                    ? "Available"
                    : "Not reported"}
                </span>
              </div>
            ...
            <AccordionContent>
              <p className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 p-3 rounded-lg">
                ...
                healthcare coverage, leave policies, and workplace transition
                guidelines.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="prideParticipation" className="border-0">
            <AccordionTrigger className="hover:no-underline">
              <div className="flex items-center justify-between w-full pr-4">
                <span className="text-sm font-medium">Pride Participation</span>
                <span className="text-sm text-gray-500">
                  {companyData.lgbtqStats?.prideParticipation
                    ? "Active"
                    : "Not reported"}
                </span>
              </div>
